...
if os.path.isfile('login_details.db') == False:
    # Imports my own library to create the Login Details database if not already made
    from database_creation import create
    create()

if os.path.isfile('question_sets.db') == False:
    # Imports my own library to create the Question Sets database if not already made
