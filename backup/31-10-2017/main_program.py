...
def spanish_learn_mode():
    ...
    try:
        ...
        main_gui.bind('<Return>',spanish_learn_process)
    except IndexError:
        try:
...
def save_backup():
    ...
    subprocess.Popen(r'explorer /select,"E:\RETURN TO 13RKS ETHAN CHAMPION\COURSEWORK STUFF\Program Stuff\Memrize\files\backup"')
